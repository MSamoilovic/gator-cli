...
func TestWindowSizeTinyTerminal(t *testing.T) {
	m, _ := step(t, newModel(t.Context(), nil, uuid.Nil), tea.WindowSizeMsg{Width: 10, Height: 2})
...
func TestErrMsgShownInView(t *testing.T) {
	m, _ := step(t, newModel(t.Context(), nil, uuid.Nil), errMsg{errors.New("baza pukla")})
...
func TestLoadingView(t *testing.T) {
	m := newModel(t.Context(), nil, uuid.Nil)
